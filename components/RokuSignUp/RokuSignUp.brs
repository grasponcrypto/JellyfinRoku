...
'    m.authScreen.buttonSignup.ObserveField("buttonSelected", "On_Signup")
    ...
    m.allDialogs = [
        ...
        m.loginAuthFlow.kbdialogServer
        m.loginAuthFlow.kbdialogPort
        m.loginAuthFlow.kbdialogUser
        m.loginAuthFlow.kbdialogPassword
        m.loginAuthFlow.dialogErrEmail
        m.loginAuthFlow.dialogErrServer
        m.loginAuthFlow.dialogErrPort
        m.loginAuthFlow.dialogErrUser
        m.loginAuthFlow.dialogErrPassword
        m.loginAuthFlow.dialogAuthFailed

        m.signupAuthFlow.kbdialogEmail
        m.signupAuthFlow.kbdialogServer
        m.signupAuthFlow.kbdialogPort
        m.signupAuthFlow.kbdialogUser
        m.signupAuthFlow.kbdialogPassword
        m.signupAuthFlow.dialogErrEmail
        m.signupAuthFlow.dialogErrServer
        m.signupAuthFlow.dialogErrPort
        m.signupAuthFlow.dialogErrUser
...
' onChange handler for "regexServer" field
sub On_regexServer()
    m.loginAuthFlow.regexServer = m.top.regexServer
    m.signupAuthFlow.regexServer = m.top.regexServer
end sub
' onChange handler for "regexPort" field
sub On_regexPort()
    m.loginAuthFlow.regexPort = m.top.regexPort
    m.signupAuthFlow.regexPort = m.top.regexPort
end sub
' onChange handler for "regexUser" field
sub On_regexUser()
    m.loginAuthFlow.regexUser = m.top.regexUser
    m.signupAuthFlow.regexUser = m.top.regexUser
end sub
...
'    m.loginAuthFlow.kbdialogServer.text = ""
...
'    m.signupAuthFlow.kbdialogServer.text = ""
